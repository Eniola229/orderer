...
<div class="breadcumb_area bg-img" style="background-image:url({{ asset('img/bg-img/breadcumb.jpg') }});">
    <div class="container h-100"><div class="row h-100 align-items-center"><div class="col-12">
        <div class="page-title text-center"><h2>404 - Page Not Found</h2></div>
    </div></div></div>
</div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="text-center" style="padding: 60px 30px; border: 1px solid #eee; border-radius: 12px;">
                    <div class="mb-4">
                        <i class="fa fa-search" style="font-size: 80px; color: #2ECC71;"></i>
                    </div>
                    <h1 style="font-size: 120px; font-weight: 800; margin-bottom: 20px; color: #2ECC71;">404</h1>
                    <h3 style="font-weight: 600; margin-bottom: 20px;">Page Not Found</h3>
                    <p style="color: #888; margin-bottom: 30px;">Sorry, the page you are looking for could not be found. It might have been moved or deleted.</p>
