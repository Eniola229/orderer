            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($w->exchange_rate && $w->currency !== 'USD')
                                <span class="badge bg-info" style="font-size:11px;">
                                    1 USD = {{ number_format($w->exchange_rate, 4) }} {{ $w->currency }}
                                </span>
                            @elseif($w->currency !== 'USD' && !$w->exchange_rate)
                        ...
                        <td>
                            @if($w->converted_amount && $w->currency !== 'USD')
    ...
    <div class="col-md-4">
        <div class="card bg-light">
            <div class="card-body py-3">
                <p class="text-muted fs-12 fw-semibold text-uppercase mb-1">Total Withdrawn (USD)</p>
