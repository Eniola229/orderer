...
<div class="card">
    <div class="card-body p-0">
        ...
        <a href="{{ route('seller.support.show', $ticket->id) }}"
           class="d-flex align-items-center gap-3 p-3 border-bottom text-decoration-none text-dark hover-bg-light">
            ...
            <div class="flex-grow-1">
                ...
                <div class="d-flex gap-3 mt-1">
                    ...
                    <small class="text-muted">
                        {{ $ticket->messages->count() }} message(s)
                    </small>
                    <small class="text-muted">
        ...
        <div class="text-center py-5 text-muted">
            <i class="feather-life-buoy mb-2 d-block" style="font-size:36px;"></i>
            No tickets yet.
            <a href="{{ route('seller.support.create') }}" class="text-primary d-block mt-2">
