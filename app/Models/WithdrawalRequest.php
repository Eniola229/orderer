...
class WithdrawalRequest extends Model {
    use HasUuid;
    protected $fillable = [
        'seller_id', 'amount', 'exchange_rate', 'converted_amount', 'bank_name', 'account_name',
        'account_number', 'bank_code', 'country_code', 'currency',
        'payout_type', 'mobile_money_operator', 'mobile_number',
        'status', 'note', 'processed_at', 'rejection_reason', 'processed_by',
        'korapay_reference', 'korapay_status', 'payout_fee'
    ];
